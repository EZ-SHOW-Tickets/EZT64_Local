...
case 2 'Unreserved only
	...
	for i=1 to ubound(Seats,2)
			...
			strCost= strCost & "<td width='420' height='6' colspan='2'>"
			'strCost= strCost & "<b><font face='Verdana' size='2'>Select number in each category</font></b></td>"
			strCost= strCost & "<b><font face='Verdana' size='2'>Select number of seats</font></b></td>"
			strCost= strCost & "</tr>"
			strCost= strCost & "<tr>"
			strCost= strCost & "<td width='420' height='6' colspan='2'>"
			strCost= strCost & "<table border='0' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#111111' width='100%'>"
	...
	//{	
	 if(t==1)
		...
		else
		{
			...
			//else if (tot > 4)
			//    {alert("Maxium number of tickets is 4");
	...
	<tr>
		<td width="100%" height="400" align="center">
			...
			<table border="0" width="600" height="9">
  				<!--<tr>    				<td width="600" height="5" align="center">					<a href="javascript:GoBack();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','images/CancelTicketsON.gif',1)"><img name="Image1" border="0" src="images/CancelTickets.gif" WIDTH="350" HEIGHT="32"></a>    				</td>  				</tr>-->
  				<tr>
